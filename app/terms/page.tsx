    ...
    <main className="mx-auto w-full max-w-4xl px-6 py-20 text-foreground motion-safe:animate-fade-up md:py-24">
      ...
      <div className="mt-10 space-y-8 leading-relaxed text-muted-foreground">
        ...
        <section>
          ...
          <p className="mt-2">
            Reservation and order requests submitted through external channels
            (such as WhatsApp) are subject to venue availability and direct
            confirmation from the respective venture.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-2">
            All branding, designs, and content on this website are owned by{" "}
            {company.name} unless otherwise stated and may not be reused without
            permission.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-2">
            For terms inquiries, contact {company.name} at{" "}
